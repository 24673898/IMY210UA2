...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "0986e6d5-3531-4910-b601-2e3e9aefe740",
...
const _lazy_5GgYIy = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_5GgYIy, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_5GgYIy, lazy: true, middleware: false, method: undefined }
];
