import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, ref, h, resolveComponent, computed, provide, Suspense, Fragment, useSSRContext, mergeProps, withCtx, createTextVNode, defineAsyncComponent, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'vue';
import { k as createHooks, l as getContext, h as createError$1, t as toRouteMatcher, m as createRouter, o as defu, p as hasProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, r as isScriptProtocol, v as executeAsync, x as parseQuery, y as withTrailingSlash, z as withoutTrailingSlash } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "project",
    path: "/project",
    component: () => import('./project.vue.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<nav class="bg-white shadow-sm py-4"><div class="max-w-6xl mx-auto px-4 flex space-x-6">`);
  ...
  _push(`</div></nav><main class="max-w-6xl mx-auto px-4 py-8">`);
